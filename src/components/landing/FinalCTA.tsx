...
const FinalCTA = () => (
  <section className="border-t border-border py-18 lg:py-20" id="docs">
    <div className="mx-auto max-w-6xl px-6">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          <a
            href="#workflow"
            className="rounded-xl bg-primary px-6 py-3.5 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90"
          >
